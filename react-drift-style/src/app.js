...
export default class DriftApp extends React.Component {
    ...
    render() {
        return (
            <Frame>
                <Carousel showIndex={this.state.showIndex} nav={this.renderNav()} width={configStyle.imageWidth}>
                    <Slide image={require('./images/1.jpg')} title="Imperial Mockery">
                        ...
                        Empire.
                        These objects were immediately removed from the reflecting pool in Coruscant's Central Square
                        when found
                        this morning.
                    </Slide>
                    ...
                    <Slide image={require('./images/3.jpg')} title="Master and Apprentice">
                        Internships work! When determining a career path, it is wise to first find someone currently in
                        that line of
                    ...
                    <Slide image={require('./images/4.jpg')} title="Battle of Coruscant">
                        Modelers ran out of the pre-Empire model Star Destroyers in this reenactment of the Battle of
                        Coruscant.
                    ...
                    <Slide image={require('./images/5.jpg')} title="The Wiles of the Forest">
                        After a number of nervous breakdowns, Empire personnel officers are investigating the
                        possibility
